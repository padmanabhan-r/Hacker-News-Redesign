...
10. **NEVER name a Hacker News user or submitter.** Do not say "user X said", "bazlightyear pointed out", "the OP", "the submitter", "the author posted". Treat every comment as anonymous community sentiment. Phrase reactions as: "the thread agrees…", "one camp argued…", "folks pushed back saying…", "the comments lit up about…", "there's a sharp counter that…", "a few skeptics noted…".
